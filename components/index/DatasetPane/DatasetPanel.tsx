"use client";
import { LaserficheSearchResult, SearchResult, USGSWaterSearchResult } from "@/app/search";
...
function DatasetPanel({ dataset, dsSource }: Props) {
	const searchResultPanel = function (dsType: USDatasetSource) {
		switch (dsType) {
			case 'PFAS':
				return <PFASDatasetPanel dataset={dataset as LaserficheSearchResult} pages={(dataset as LaserficheSearchResult).nodes} />
