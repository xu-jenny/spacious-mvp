...
const USGSWaterDatasetPane = ({ dataset }: Props) => {
    ...
    const downloadCSV = async () => {
        ...
        const response = await post(`${process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL}/usgs_water_csv`, {
            ...
            <div className="w-full flex flex-col h-full">
                <article className="prose p-4 max-w-none">
                    ...
                    <div className="flex gap-4">
                        <Link
                            href={`https://dashboard.waterdata.usgs.gov/api/gwis/2.1.1/service/site?agencyCode=USGS&siteNumber=${dataset.id.substring(5)}&open=53764`}
                            target="_blank"
